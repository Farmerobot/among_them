...
from among_them.engine.phase_filters import get_last_discussion_action_idx
from among_them.models.location import Location

def get_next_random_player(history: List[History], players: List[Player]) -> tuple[Player, List[Player]]:
...
def get_players_in_room(history: List[History], players: List[Player], location: Location) -> List[Player]:
